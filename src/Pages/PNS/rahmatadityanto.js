...
class RahmatAdityanto extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
                  ...
                  <Table basic="very" celled collapsing>
                    ...
                    <Table.Body>
                      <Table.Row>
                        ...
                        <Table.Cell>Rahmat Adityanto, ST</Table.Cell>
                      </Table.Row>
                      <Table.Row>
                        <Table.Cell>
                          <Header as="h4">
                        ...
                        <Table.Cell>19860503 201101 1 003</Table.Cell>
                      </Table.Row>
                      <Table.Row>
                        <Table.Cell>
                          <Header as="h4">
...
export default RahmatAdityanto;
