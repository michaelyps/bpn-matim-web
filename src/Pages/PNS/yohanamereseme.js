...
class YohanaMereSeme extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
                  ...
                  <Table basic="very" celled collapsing>
                    ...
                    <Table.Body>
                      <Table.Row>
                        ...
                        <Table.Cell>Yohana Mere Seme, ST</Table.Cell>
                      </Table.Row>
                      <Table.Row>
                        <Table.Cell>
                          <Header as="h4">
                        ...
                        <Table.Cell>19830612 200804 2 002</Table.Cell>
                      </Table.Row>
                      <Table.Row>
                        <Table.Cell>
                          <Header as="h4">
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>Kepala Sub Bagian Tata Usaha</Table.Cell>
                      </Table.Row>
                    </Table.Body>
                  </Table>
                </Grid.Column>
